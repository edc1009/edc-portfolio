        ...
        <div className="space-y-content-md">
          ...
          <div className="space-y-content-sm">
            <BlurFade delay={BLUR_FADE_DELAY * 11}>
              <div className="max-w-xl text-pretty font-sans text-sm text-muted-foreground dark:text-muted-foreground">
                I’m Edward—a PM who turns logistics chaos into calm with AI. Built a container tracker and email Kanban that slashed busywork by 60%. Northeastern MS (4.0). When I’m not shipping product, I’m chasing forehands on the tennis court.
              </div>
            </BlurFade>
          </div>
        </div>
